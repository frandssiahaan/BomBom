...
echo color("green","| github: Rip.R....|\n");
echo color("blue","| sponsor  : PT.Gojek Indonesia|\n");
echo color("yellow","| Creator : R......com          |\n");
echo "| Kata sambutan : Kalau sudah dapat banyak,jngn lupa sedekah atau traktir Bom Bom minum Kopi ya      |\n";
